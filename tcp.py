...
class TCPTopo(Topo):
    ...
    def build(self, n=2):
        ...
        self.addLink(host0, switch,bw=1000, delay='100ms', loss=0,
                          max_queue_size=100, use_htb=True)
        host2 = self.addHost('h2')
        self.addLink(host2, switch,bw=2, delay='100ms', loss=0,
                          max_queue_size=100, use_htb=True)
